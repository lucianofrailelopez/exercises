...
console.log("Mayo", "Noviembre");

/* b) Ordenar el array de meses alfabéticamente y mostrarlo por consola (utilizar sort). */

var año = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
"Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];
...
console.log(meses.unshift("banana"), meses.push("manzana"));

/* d) Quitar un elemento del principio y del final del array (utilizar shift y pop). */

console.log(meses.shift(), meses.pop());

/* e) Invertir el orden del array (utilizar reverse). */

var _mes = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
"Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"];

console.log(_mes.reverse());
